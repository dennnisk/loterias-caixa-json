...
exports.downloadResultados = async function (folder, url, loteria, arquivoHtmlComResultados) {
  //return new Promise(function (resolve, reject) {
    ...
    const options = {
      pasta: folder,
      nome: arquivoHtmlComResultados //'megasena.zip'
    };
    ...
    return await _download(url, options)
      .then(function (fileId) {
        ...
        pastaDestino = folder; //path.join(folder, loteria);
        //_unzip(fileId, pastaDestino);
        let nomeArquivoHTMLResultados = path.join(pastaDestino, arquivoHtmlComResultados);
        console.log('Downloaded: ', nomeArquivoHTMLResultados);
        return nomeArquivoHTMLResultados
      });
 ...
 */
exports.downloadResultadosZip = function (folder, url, loteria, arquivoComResultados) {
  return new Promise(function (resolve, reject) {
    // Cria a promise
    //const url = 'http://www1.caixa.gov.br/loterias/_arquivos/loterias/D_megase.zip';
